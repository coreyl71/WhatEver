...
public class DragGrid extends GridView {
    ...
    private void onDrop(int x, int y) {
        ...
        UserChannelAdapter channelAdapter = (UserChannelAdapter) getAdapter();
        //显示刚拖动的ITEM
        channelAdapter.setShowDropItem(true);
        //刷新适配器，让对应的ITEM显示
    ...
    public void setOnItemClickListener(final MotionEvent ev) {
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                TextView dragTextView = (TextView) dragViewGroup.findViewById(R.id.tv_channel_item);
                ...
                if (dragPosition != AdapterView.INVALID_POSITION) {
                    ...
                    win_view_y = windowY - dragViewGroup.getTop();//VIEW相对自己的y，半径
...
//		this.windowParams.y = (y - this.win_view_y + this.viewY);//位置的y值
    ...
    private void hideDropItem() {
        ((UserChannelAdapter) getAdapter()).setShowDropItem(false);
    }
                    ...
                    moveAnimation.setAnimationListener(new AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ...
                            if (animation.toString().equalsIgnoreCase(LastAnimationID)) {
                                UserChannelAdapter channelAdapter = (UserChannelAdapter) getAdapter();
                                channelAdapter.exchange(startPosition, dropPosition);
